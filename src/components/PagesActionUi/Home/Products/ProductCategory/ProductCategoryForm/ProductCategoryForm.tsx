...
const ProductCategoryForm: React.FC<CategoryFormProps> = ({ initialData }) => {
  const params = useParams() as { productCategoryId: string };
    ...
    try {
      ...
      if (initialData) {
        const response = await axios.patch(
          `${DOMAIN}/api/home/products/productCategory/${params.productCategoryId}`,
          data
        );
        console.log("Update Response:", response.data);
      } else {
        const response = await axios.post(
          `${DOMAIN}/api/home/products/productCategory`,
          data
        );
      ...
      router.push(`/home/products/productCategory`);
      router.refresh();
