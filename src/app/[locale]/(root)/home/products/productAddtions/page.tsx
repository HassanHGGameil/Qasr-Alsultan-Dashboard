...
import ProductAddtionsClient from "@/components/PagesActionUi/Home/Products/ProductAddtions/ProductAddtionsClient/ProductAddtionsClient";
...
const PkgRecipes = async () => {
  ...
  const formatedProductAddtions: ProductAdditionColumntype[] = productAddtions.map((item) => ({
    id: item.id,
