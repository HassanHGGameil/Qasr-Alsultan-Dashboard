...
import ProductCategoryClient from "@/components/PagesActionUi/Home/Products/ProductCategory/ProductCategoryClient/ProductCategoryClient";
...
const CategoriesPage = async () => {
  ...
  const formatedCategories: CategoryColumnType[] = productCategory.map((item) => ({
    id: item.id,
    nameEn: item.nameEn,
    nameAr: item.nameAr,
