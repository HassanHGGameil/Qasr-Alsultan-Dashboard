import ProductAddionsForm from "@/components/PagesActionUi/Home/Products/ProductAddtions/ProductAddtionsForm/ProductAddtionsForm";
    ...
    return (
      <div className="flex-col w-full">
        <div className="flex-1 space-y-4 p-8 pt-6">
          <ProductAddionsForm initialData={null} productCategory={productCategory}  />
        </div>
      </div>
    );
  }
